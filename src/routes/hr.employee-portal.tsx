...
export const Route = createFileRoute("/hr/employee-portal")({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "One place for assignment, tasks, leave and documents." },
    ],
  }),
  ...
  return (
    <>
      <PageHeader
        ...
        actions={
          <>
            <ConsoleButton>Request document</ConsoleButton>
            <ConsoleButton variant="primary">+ Raise HR Request</ConsoleButton>
          </>
        }
      />
      ...
      <div className="grid grid-cols-2 gap-3 sm:grid-cols-4">
        ...
        <StatTile label="HR Requests" value={0} note="none open" tone="success" />
      </div>
        ...
        <Panel title="Announcements & Sonia" bodyClassName="space-y-3 p-4">
          <div className="console-inset p-3">
            ...
            <p className="mt-1.5 text-[12px] leading-relaxed text-dim">
              ABC Company site induction runs every Monday at 08:30. Bring your ID card and signed contract copy.
            </p>
          </div>
